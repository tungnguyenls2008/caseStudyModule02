        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-warning">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto topnav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="view/user/display.php">Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view/book/display.php">Books</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-danger text-white" type="button" href="view/user/registration.php" data-toggle="modal" data-target="#myModal">Register</a>
                    </li>
                </ul>
            </div>
