        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto topnav">
                ...
                if ($_SESSION['user']):?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="/caseStudy/view/user/profile.php?id=<?php echo $_SESSION['user']['mem_id'] ?>">Hello, <?php echo $_SESSION['user']['firstname'] ?></a>
                    </li>
                    <li class="nav-item">
                ...
                <?php if (!$_SESSION['user']): ?>
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary text-white" type="button" href="/caseStudy/index.php">Sign
                            In</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-danger text-white" type="button"
                           href="/caseStudy/view/user/registration.php">Register</a>
                    </li><?php endif; ?>
                <?php if ($_SESSION['user']): ?>
                    <li class="nav-item">
                        <a class="nav-link btn btn-danger text-black-50" type="button"
                           href="/caseStudy/model/user/logout.php"
                        >LOGOUT</a>
                    </li>
                <?php endif; ?>
            </ul>
